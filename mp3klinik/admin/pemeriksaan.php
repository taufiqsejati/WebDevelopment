...
<a href='pemeriksaan_input.php'>Input Data Pemeriksaan</a>
...
$r2= mysqli_fetch_array($tampil2);
		...
		<td><a href='pemeriksaan_delete.php?id=$r[id_pemeriksaan]'>Del</a>  | 
		<a href='pemeriksaan_edit.php?id=$r[id_pemeriksaan]'>Edit</a> |
